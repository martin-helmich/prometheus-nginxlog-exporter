...
image::https://quay.io/repository/martinhelmich/prometheus-nginxlog-exporter/status(https://quay.io/repository/martinhelmich/prometheus-nginxlog-exporter[Docker Repository on Quay]
